...
static tree_t *make_tree_node(op_t op, tree_t *left, tree_t *right);
static tree_t *make_atom(char c);
static tree_t *term(void);
static tree_t *factor(void);
static tree_t *primary(void);
