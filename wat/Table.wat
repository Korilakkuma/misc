(module
  (import "js" "increment" (func $jsIncrement (result i32)))
  (import "js" "decrement" (func $jsDecrement (result i32)))
  ...
  (elem (i32.const 0) $jsIncrement $jsDecrement $increment $decrement)
)
